...
import pagina1, pagina2, pagina3, pagina4, pagina7, pagina8, pagina_admin, pagina10, pagina11, pagina12, pagina13, pagina14, pagina15, pagina16, pagina17,pagina18,pagina19,pagina21,pagina40,pagina30
...
PAGES = {
    ...
    "pagina12": pagina12.app, "pagina13": pagina13.app, "pagina14": pagina14.app, "pagina15": pagina15.app,
    "pagina16": pagina16.app, "pagina17": pagina17.app, "pagina18": pagina18.app, "pagina19": pagina19.app, "pagina21": pagina21.app, "pagina40": pagina40.app , "pagina30": pagina30.app
}
...
def tela_login():
    ...
    <div style='text-align: center; font-family: Arial, Helvetica, sans-serif;'>
        <img src="https://www.dolpengenharia.com.br/wp-content/uploads/2021/01/logotipo-definitivo-250614.png" width="200"><br>
        <h1 style='font-size:30px; font-weight:bold; color:#3e4095;'>SISTEMA DE GESTÃO DE INDICADORES</h1>
    </div>
    """,
    unsafe_allow_html=True
)
    ...
    with col2:
        ...
        <div style="text-align: center; color: #666; font-size: 0.9rem;">
            Utilize o mesmo usuário e senha do sistema SGD para efetuar o login
        </div>
        """, unsafe_allow_html=True)
...
def aba_operacional():
    ...
    if "pagina21" in permissoes and st.button("PREVISTO X PRODUZIDO", key="btn_p21"):
        st.session_state.current_page = 'pagina21'; st.rerun()    
    if  "pagina30" in permissoes and st.button("RELATORIO DE HHT X HHE", key="btn_p30"):
        st.session_state.current_page = 'pagina30'; st.rerun()
...
def aba_sesmt():
    ...
    if "pagina14" in permissoes and st.button("INSPEÇÕES - TAXA DE CONTATO - EQUIPES - REGIONAL MORRINHOS", key="btn_p14"):
        st.session_state.current_page = 'pagina14'; st.rerun() 
    if "pagina15" in permissoes and st.button("INSPEÇÕES - TAXA DE CONTATO - EQUIPES - REGIONAL RIO VERDE", key="btn_p15"):
        st.session_state.current_page = 'pagina15'; st.rerun() 
    if "pagina16" in permissoes and st.button("INSPEÇÕES - TAXA DE CONTATO - EQUIPES - REGIONAL TO", key="btn_p16"):
        st.session_state.current_page = 'pagina16'; st.rerun()  
    if "pagina17" in permissoes and st.button("INSPEÇÕES - TAXA DE CONTATO - EQUIPES - REGIONAL MT", key="btn_p17"):
        st.session_state.current_page = 'pagina17'; st.rerun() 
    if "pagina40" in permissoes and st.button("INSPEÇÕES - TAXA DE CONTATO - EQUIPES - GERAL POR PREFIXO", key="btn_p40"):
        st.session_state.current_page = 'pagina40'; st.rerun()    
...
def aba_monitoria():
    ...
    if "pagina18" in permissoes and st.button("APONTAMENTO DE NÃO CONFORMIDADES", key="btn_p18"):
        st.session_state.current_page = 'pagina18'; st.rerun()
    if "pagina19" in permissoes and st.button("IA DOLP", key="btn_p19"):
        st.session_state.current_page = 'pagina19'; st.rerun()     
def aba_admin():
